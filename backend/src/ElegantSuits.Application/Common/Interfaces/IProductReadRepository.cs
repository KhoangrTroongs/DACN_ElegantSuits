...
public interface IProductReadRepository
{
    ...
    Task<PaginatedList<ProductResponse>> GetPagedProductsAsync(int? categoryId, int pageIndex, int pageSize, bool includeHidden = false, string? keyword = null, CancellationToken cancellationToken = default);
